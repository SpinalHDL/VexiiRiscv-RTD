...
project = 'VexiiRiscv'
copyright = '2023 - ' + str(datetime.date.today().year) + ', VexiiRiscv'
author = 'VexiiRiscv contributors'
...
htmlhelp_basename = 'VexiiRiscvdoc'
...
latex_documents = [
    (master_doc, 'VexiiRiscv.tex', 'VexiiRiscv Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'vexiiriscv', 'VexiiRiscv Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'VexiiRiscv', 'VexiiRiscv Documentation',
     author, 'VexiiRiscv', 'One line description of project.',
     'Miscellaneous'),
]
...
html_context = {
    ...
    'github_repo': os.getenv('GITHUB_REPOSITORY_NAME', 'VexiiRiscv-RTD'), # Repo name
